...
Начало фиксации Правила - ментальный запуск моторного автомтаизма (MentalAutomatism.ActionsImageID ->  activateMotorID).
...
Так же при этом проставляется MentalAutomatism.Usefulness автоматизму, запустившему действие (вообще MentalAutomatism нивелируется Правилами).
