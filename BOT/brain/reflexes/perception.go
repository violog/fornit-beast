...
сброс активации для 2,3 стадий в делается в automatismActionsPuls() при превышении времени ожидания ответа WaitingPeriodForActionsVal
В 4 стадии это так же можно делать произвольно, при помощи IsArbitraryGameMode: True - активировать игровой режим. Этот же флаг, пока True, не дает игровому режиму погаснуть в automatismActionsPuls()
